...
export default function PremiumGuard({ children, featureName = "Esta función", isShop = false }) {
    ...
    const openWhatsApp = () => {
        const message = `Hola! Quiero adquirir una licencia Premium para Pool Imperial. Mi ID de instalación es: ${deviceId}`;
    ...
    if (isShop) {
        title = <span>Pool Imperial <span className="text-amber-500">Business</span> 👑</span>;
        ...
        title = <span>Pool Imperial <span className="text-amber-500">Premium</span> 👑</span>;
