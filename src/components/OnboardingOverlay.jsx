...
const STEPS = [
    ...
    },
    {
        ...
        tip: '💡 Sincronización en la nube para mantener tu negocio actualizado.',
    },
    {
        icon: ShoppingCart,
        color: 'text-blue-500',
        ...
        description: 'Agrega productos al carrito, aplica descuentos y cobra en efectivo, Nequi, Daviplata, transferencia o datáfono. El sistema procesa los pagos en COP.',
    ...
    },
    {
        ...
        descriptionFree: 'Pool Imperial Free incluye uso ilimitado y gratis para siempre. Guarda hasta 50 productos y administra tu negocio al instante.',
        descriptionPremium: 'Con Pool Imperial Premium puedes gestionar un inventario ilimitado, cobrar con POS y compartir tu inventario.',
    ...
    },
    {
        ...
        descriptionFree: 'Con Pool Imperial Premium puedes gestionar tu cartera de clientes y control de deudas.',
                    ...
                    {isWelcome ? (
                        ...
                        <div className="p-8 text-center relative overflow-hidden">
                            ...
                            <p className="text-sm text-slate-500 leading-relaxed mb-6 max-w-[260px] mx-auto">
                                Inventario, ventas, mesas de pool y gestión de clientes en una sola app, diseñada para el mercado colombiano.
                            </p>
